...
const SignUp = () => {
  ...
  const handleSocialSignUp = (provider: string) => {
    ...
    toast({
      ...
      description: `Регистрация через ${provider} будет доступна в ближайшее время`,
    });
  };
        ...
        <Card className="shadow-2xl border-0 bg-card/95 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-muted-foreground">
              Зарегистрируйтесь для доступа к анализу кожи
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground">или зарегистрируйтесь через</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="h-12 transition-all duration-200 hover:scale-[1.02]"
                >
